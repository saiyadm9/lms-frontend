...
import { courseDetails } from "../../../../../../data/categories"; // Import the icon
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg my-8">
      ...
      <section className="space-y-4 mt-4">
        ...
        {/* <p>
          <Link
            href={`${courseDetail?.outline}`}
            className="link link-primary text-lg font-semibold mt-4"
            target="_blank"
          >
            Course Outline
          </Link>
        ...
        {/* <p className="text-lg text-gray-700">
          <a
            href={courseDetail?.curriculum.link}
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500 hover:underline"
          >
            {courseDetail?.curriculum.text}
          </a>
        </p> */}
...
// Wrap CourseDetails with withHero and pass the dynamic course name
export default withHero(CourseDetails, {
