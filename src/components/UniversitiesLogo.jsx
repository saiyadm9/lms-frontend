  ...
  return (
    <section className="bg-[#F3F4F6] py-12 px-10">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-8 gap-6 justify-items-center align-items-center">
          {logos.map((logo, index) => (
            <div
              key={index}
              className="flex justify-center items-center bg-white p-4 rounded shadow-sm w-full"
            >
              <Image
                src={logo.src}
                alt={logo.alt}
